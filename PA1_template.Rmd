...
## Introduction 
This is the first assignment of the course *Reproducable Research*.

Data for this assignment is downloaded from the course website at [Dataset] (https://d396qusza40orc.cloudfront.net/repdata%2Fdata%2Factivity.zip)
